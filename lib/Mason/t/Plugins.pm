...
BEGIN {
  $Mason::Test::Plugins::A::VERSION = '2.16';
} use Moose; with 'Mason::Plugin'; }
{ package Mason::Plugin::B;
BEGIN {
  $Mason::Plugin::B::VERSION = '2.16';
}        use Moose; with 'Mason::Plugin'; }
{ package Mason::Plugin::C;
BEGIN {
  $Mason::Plugin::C::VERSION = '2.16';
}        use Moose; with 'Mason::Plugin'; }
{ package Mason::Plugin::D;
BEGIN {
  $Mason::Plugin::D::VERSION = '2.16';
}        use Moose; with 'Mason::Plugin'; }
{ package Mason::Plugin::E;
BEGIN {
  $Mason::Plugin::E::VERSION = '2.16';
}        use Moose; with 'Mason::Plugin'; }
{
    package Mason::PluginBundle::F;
BEGIN {
  $Mason::PluginBundle::F::VERSION = '2.16';
}
    use Moose;
...
BEGIN {
  $Mason::Test::PluginBundle::G::VERSION = '2.16';
}
    use Moose;
    with 'Mason::PluginBundle';
...
BEGIN {
  $Mason::PluginBundle::I::VERSION = '2.16';
}
    use Moose;
    with 'Mason::PluginBundle';
...
BEGIN {
  $Mason::PluginBundle::J::VERSION = '2.16';
}
    use Moose;
    with 'Mason::PluginBundle';
...
BEGIN {
  $Mason::Test::Plugins::Upper::VERSION = '2.16';
} use Moose; with 'Mason::Plugin' }
{
    package Mason::Test::Plugins::Upper::Request;
BEGIN {
  $Mason::Test::Plugins::Upper::Request::VERSION = '2.16';
}
