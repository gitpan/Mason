...
the Moose attribute properties). e.g. this block
...
itself! When all else fails, use L<Mason::Request/print>:
...
You can also call components with the L<Mason::Request/comp> and
L<Mason::Request/scomp> methods.
