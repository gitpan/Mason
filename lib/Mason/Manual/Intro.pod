...
L<Mason::Manual::Tutorial> for a more expansive tour of building a web site
with Mason.
...
In a test directory, create a directory C<comps> and create a file C<email.mcc>
with the following:
...
I<attributes>, C<$.amount> and C<$.name>, to be passed into the component; and
...
Line 4 runs the template - notice that the C<.mcc> extension is added
