...
set up a Mason psgi app:
    ...
    writing blog/comps/Base.m
    writing blog/comps/index.m
    Run
...
this with our second page component, C</new_article.m>. It contains only HTML
(for now).
...
Any component named Base.m is an L<autobase|Mason::Manual::Components/Autobase
components> component. It automatically becomes the superclass of any component
in its directory and below. Thus, C</index.m> and C</node/view.m> both
automatically inherit from C</Base.m>.
...
a C<.m> component containing a single C<< <%class> >> block, but this is easier
