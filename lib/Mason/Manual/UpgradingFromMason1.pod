...
L<Mason::Request/add_cleanup> to add cleanup code for the end of the request,
which is good enough in most cases, or you can add a C<DEMOLISH> method to the
component.
